UI_MESSAGES = {
    ...
    "help": {
        "content": [
            ...
            "| `/embed <dir> <collection>` | Embed documents from directory |",
            "| `/collections` | List embedding collections |",
            "| `/list_all_docs` | List all documents in knowledge base |",
            "| `/query <text>` | Search embeddings |",
